<%@ Page Title="" Language="C#" MasterPageFile="~/Sitemaster.Master" AutoEventWireup="true" CodeBehind="BakhoorSultan.aspx.cs" Inherits="Agarwood.BakhoorAlSultan" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
    <div class="column">
    <img src="oud/Bakhoor Sultan Al Oud.jpg" style="width:100%"  class="hover-shadow cursor"> 
  </div>
   <table>
